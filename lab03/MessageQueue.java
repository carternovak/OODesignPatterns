...
public class MessageQueue
{
   ...
   */
   ...
   {
      int before = (tail - head - count) % elements.length; // calculate the equation before remove
   ...
   */
   ...
   {
      int before = (tail - head - count) % elements.length;
      count++; //update count
      ...
      int after = (tail - head - count) % elements.length;
      assert after == before : " Changed!";
